...
//			}
			...
			if(resultMember != null){
				...
				session.setAttribute("session_mem_email", resultHost.getEmail());
				session.setAttribute("session_mem_name", resultHost.getName());
				session.setAttribute("session_mem_no", resultHost.getNo());
