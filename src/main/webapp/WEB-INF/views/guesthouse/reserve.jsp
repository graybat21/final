...
<body class="pcweb" oncontextmenu="return false"
	...
	<article id="contentsWrap">
		...
		<div class="addetail_wrap" style="text-align: left;">
			...
			var alat = "37.49904037";
			var alng = "127.0285163";
			showMap();
 ...
 */
			...
			function showMap(){
				...
				daum.maps.event.addListener(map, 'click', function(mouseEvent) {        
					window.open('http://map.daum.net/link/map/강남 제리스플래닛,' +  alat + ',' +  alng + '');
				});
				//  중심 좌표, 확대수준 변경
				...
				<div class="new_info row">
					...
					<div id="maparea" class="map"
						...
						<div
							...
							<div style="font: 11px tahoma, sans-serif; float: left; margin: 3px 2px 0px;">
								© Kakao<span></span>
							</div>
						</div>
						<div
