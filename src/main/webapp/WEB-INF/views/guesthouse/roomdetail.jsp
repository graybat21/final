											...
											<div class="collapsed" style="max-height: 100px; padding: 0 10px 10px 0">
												<div>
													<div class="hotel-desc">
														저희 게스트하우스에서는 양질의 숙박과 훌륭한 서비스를 제공합니다. 저희 게스트하우스에서 집과 같은
														편안함을 느껴보시기 바랍니다. 이 곳에서 생동감 넘치는 지역 경험의 많은 것을 최대로 즐길 수 있습니다.
														숙소가 산과 바다, 그리고 이 지역의 시내 등의 관광구와 인접한 위치에 있기에 지역의 관광
